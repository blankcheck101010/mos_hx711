...
const struct mgos_conf_entry sys_config_schema_[102] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .num_desc = 101},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "mqtt", .num_desc = 14},
  ...
  {.type = CONF_TYPE_STRING, .key = "pub", .offset = offsetof(struct sys_config, mqtt.pub)},
  {.type = CONF_TYPE_STRING, .key = "sub", .offset = offsetof(struct sys_config, mqtt.sub)},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "wifi", .num_desc = 20},
